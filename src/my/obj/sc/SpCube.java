...
public class SpCube extends SpObject {
	...
	private static final Q q0 = new Q(p0, p1, p3, p2, redc); // left
	private static final Q q1 = new Q(p6, p7, p5, p4, darkredc); // right
	private static final Q q2 = new Q(p4, p5, p1, p0, greenc); // bottom
	private static final Q q3 = new Q(p2, p3, p7, p6, darkgreenc); // top
	private static final Q q4 = new Q(p0, p2, p6, p4, bluec); // near
	private static final Q q5 = new Q(p5, p7, p3, p1, darkbluec); // far
